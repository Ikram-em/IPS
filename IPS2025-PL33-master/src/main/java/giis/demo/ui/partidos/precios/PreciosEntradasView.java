...
public class PreciosEntradasView extends JFrame {
	...
	public PreciosEntradasView(PartidoDTO partido) {
	...
	private JPanel getPnTitle() {
		...
		pnTitle.add(createLabel("Entradas " + partido.toString(), Font.BOLD, 20));
		return pnTitle;
	}
	...
	private JPanel getCenterPn() {
		...
		centerPanel.add(getTribunePriceMapPn());
	...
	public PnPrecioGeneral getPnPrecioGeneral() {
		if (pnPrecioGeneral == null) {
			pnPrecioGeneral = new PnPrecioGeneral(null);
		}
	...
	public JPanel getTribunePriceMapPn() {
