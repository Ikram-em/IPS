...
public class ProcessShowScheduleButton implements ActionListener{
	
	private EmployeeViewDTO employee;
	private ScheduleMenuView scheduleView;
	private AuditService audit;
	
	public ProcessShowScheduleButton(ScheduleMenuView scheduleView, EmployeeViewDTO employee, AuditService audit) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		scheduleController.showShowSchedule();
	}
